...
- **Cookies and local storage**: Any local storage or cookies used by a deployed web app instance are controlled by the site operator and the user's browser.
- **Contributions**: If you contribute via GitHub (issues, pull requests), GitHub's terms and privacy policy apply to the data you provide.

Contact: If you have questions about privacy, open an issue on this repository or contact the project owner.
